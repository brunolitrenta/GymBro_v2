...
const exercisePage = () => {
  ...
  return (
    <SafeAreaView
      edges={["top"]}
      className="flex-1 justify-evenly items-center bg-primary"
    >
      ...
      <View className="w-5/6 h-1/4 justify-center items-center border-2 border-black rounded-3xl">
        <Text>Imagem</Text>
      </View>
      <View className="flex-row w-5/6 justify-between items-center">
        <View className="w-1/3 h-20 justify-evenly items-center">
          ...
          <View className="flex-row w-full items-center justify-evenly">
            ...
            <Link href="/modals/editExercisePropsModal" asChild>
              <TouchableOpacity>
      ...
      <View className="w-5/6 h-1/3 bg-stronggreen rounded-2xl justify-center items-center">
        ...
        <Text className="font-rsemi text-base text-textcolor opacity-50">
